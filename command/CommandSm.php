...
class CommandSm extends ChengxufanThumbCommand {
	public function run($sfile, $dfile, $dmine, $value) {
		...
		$dw = $dw > $this->ssize[0] ? $this->ssize[0] : $dw;
		$dh = $dh > $this->ssize[0] ? $this->ssize[0] : $dh;

		$diw = $dw > $this->ssize[0] ? $this->ssize[0] : $dw;
		$dih = $dh > $this->ssize[1] ? $this->ssize[1] : $dh;
